...
describe('ShareDialogTabsView', () => {
  ...
  it('renders with interactive api sharing', async () => {
    ...
    expect(screen.getByTestId('sharing-tab-link')).toContainHTML('Link')
    expect(screen.getByTestId('sharing-tab-embed')).toContainHTML('Embed')
    expect(screen.getByTestId('sharing-tab-api')).toContainHTML('Activity Player')
    expect(screen.queryByTestId('link-tab-contents')).toBeNull()
    expect(screen.queryByTestId('embed-tab-contents')).toBeNull()
